...
void ErrorReport::SnapshotError(EXCEPTION_RECORD* exception, CONTEXT* context)
{
    ...
    fullErrorDescription << "* https://github.com/SpencerEverly/smbx2-seemod/issues\n";
    fullErrorDescription << "\n";
    fullErrorDescription << "Reporting these bugs help out with the development of this engine!\n";
    fullErrorDescription << "\n";
